    ...
    return (
      ...
      >
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 w-full md:max-w-4xl md:rounded-3xl rounded-t-3xl max-h-[90vh] overflow-hidden flex flex-col relative shadow-2xl border-t-4 border-purple-500 md:border-t-0 md:border md:border-gray-700"
          ...
          {stats.map((stat) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative bg-gray-900/80 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-4 md:p-6 text-center hover:border-gray-600 transition-all">
                  <motion.div
                    whileHover={{ rotate: 360 }}
                    transition={{ duration: 0.5 }}
                    className={`inline-flex p-2 md:p-3 rounded-full bg-gradient-to-r ${stat.gradient} mb-3 md:mb-4`}
                  >
